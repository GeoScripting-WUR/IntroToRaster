...
## How to submit
You should submit the function via GitHub. Either put the function file in a sub-directory of your ''GeoScriptingExercises'' repository, or in a new repository (i.e.: ''Exercise3''). Send the clone url of that repository to me.
In addition, add a few lines to run the function and visualize the results at the end of the function file.

And finally, do not forget to put your name at the top of the function file. You should obtain something like in the figure below.
