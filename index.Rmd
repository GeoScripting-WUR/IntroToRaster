...
If you plan to work with MODIS data*, as additional to the tutorial content, it will be useful for you in the future to look at the information [here](hdf.html), about handling HDF4 format files with R.
