...
I would like to know if Wageningen and its surrounding has changed with respect to its spring NDVI over the past 30 years. For that I would need to do a bi-temporal comparison of two NDVI images, acquired in spring. Simply substracting the images should work, but unfortunately these haven't been pre-processed yet. I managed to download two Landsat raw surface reflectance products covering the area. They were acquired around the same period of the year at about 30 years interval, but I don't know how to compare them. Can you please help me?

## More details

* Data can be found [here](https://www.dropbox.com/s/s25unypnywquscl/LT51970241985109-SC20150107035640.tar.gz?dl=0) and [here](https://www.dropbox.com/s/i1ylsft80ox6a32/LC81970242014109-SC20141230042441.tar.gz?dl=0).
